...
- `probe` prints the hardware/backend summary, includes a synthetic MoE telemetry preview with cold offload/reload counts, and also supports `--format json`.
...
.\scripts\post-publish-smoke.ps1 -ArtifactPath ".\dist\us4-v6-windows-$version-portable.zip"
...
.\scripts\render-winget-manifests.ps1 -Version $version
...
.\scripts\render-release-notes.ps1 -Version $version -ReleaseManifestPath .\dist\release-manifest.json
...
.\scripts\post-publish-smoke.ps1 -ArtifactPath ".\dist\us4-v6-windows-$msixVersion.msix" -EnableDevMsixSmoke -DevCertificatePassword us4-dev-pass
.\scripts\sign-msix.ps1 -PackagePath ".\dist\us4-v6-windows-$msixVersion.msix"
.\scripts\preflight-release.ps1 -BuildDir build
.\scripts\install-msix-smoke.ps1 -PackagePath ".\dist\us4-v6-windows-$msixVersion.msix"
```
