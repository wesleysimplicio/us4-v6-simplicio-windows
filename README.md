...
.\scripts\post-publish-smoke.ps1 -ArtifactPath .\dist\us4-v6-windows-0.1.54-portable.zip
...
.\scripts\render-winget-manifests.ps1 -Version 0.1.54
...
.\scripts\render-release-notes.ps1 -Version 0.1.54 -ReleaseManifestPath .\dist\release-manifest.json
...
.\scripts\post-publish-smoke.ps1 -ArtifactPath .\dist\us4-v6-windows-0.1.54.0.msix -EnableDevMsixSmoke -DevCertificatePassword us4-dev-pass
.\scripts\sign-msix.ps1 -PackagePath .\dist\us4-v6-windows-0.1.54.0.msix
.\scripts\preflight-release.ps1 -BuildDir build
.\scripts\install-msix-smoke.ps1 -PackagePath .\dist\us4-v6-windows-0.1.54.0.msix
```
