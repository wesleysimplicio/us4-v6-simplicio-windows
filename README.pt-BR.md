...
.\scripts\post-publish-smoke.ps1 -ArtifactPath .\dist\us4-v6-windows-0.1.32-portable.zip
...
.\scripts\render-winget-manifests.ps1 -Version 0.1.32
...
.\scripts\render-release-notes.ps1 -Version 0.1.32 -ReleaseManifestPath .\dist\release-manifest.json
.\scripts\render-planning-status.ps1 -Format markdown -OutputPath .\.specs\sprints\STATUS.md
.\scripts\sign-msix.ps1 -PackagePath .\dist\us4-v6-windows-0.1.32.0.msix
.\scripts\preflight-release.ps1 -BuildDir build
.\scripts\install-msix-smoke.ps1 -PackagePath .\dist\us4-v6-windows-0.1.32.0.msix
```
